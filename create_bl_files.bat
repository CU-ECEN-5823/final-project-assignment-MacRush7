...
if "%PATH_GCCARM%"=="" (
  set OBJCOPY="E:\Programs\SiliconLabs\SimplicityStudio\v4\developer\toolchains\gnu_arm\4.9_2015q3\bin\arm-none-eabi-objcopy.exe"
) else (
...
if "%PATH_SCMD%"=="" (
  set COMMANDER="E:\Programs\SiliconLabs\SimplicityStudio\v4\developer\adapter_packs\commander\commander.exe"
) else (
